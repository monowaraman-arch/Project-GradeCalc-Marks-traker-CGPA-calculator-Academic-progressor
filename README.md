...
Overview of total courses, current semester CGPA, all-time CGPA, total credits, CGPA settings, and course summary.

![Dashboard](Screenshots/dashboard.png)

### Courses

Course management screen for viewing all added courses and opening each course detail page.

![Courses](Screenshots/courses.png)

### Course Details

Detailed course result view showing final marks, letter grade, grade point, weighted grade point, and course actions.

![Course Details](Screenshots/course-details.png)

### Mark Distribution

Marks entry area for course components such as attendance, quizzes, midterm, assignments, and final exam.

![Mark Distribution](Screenshots/mark-distribution.png)

### Result Report

Semester report view with CGPA summary, course results, CSV download, and print support.

![Result Report](Screenshots/report.png)

### Grading System

Custom grading scale page for editing percentage ranges, letter grades, descriptions, and grade points.

![Grading System](Screenshots/grading.png)

### Data Management

Backup and restore page for exporting, importing, resetting, or clearing grade data.
